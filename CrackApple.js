...
h += '<option value="MGAC2J/A">iPhone 6 Plus 灰 128G</option>';
    ...
    h += '	E-mail：<input type="text" name="email" value="229547798@qq.com" /><br />';
    h += '	名：<input type="text" name="firstName" value="Li" /><br />';
    h += '	姓：<input type="text" name="lastName" value="Dong" /><br />';
    h += '	<input type="hidden" name="p_ie" value="" />';
    h += '	电话：<input type="text" name="phoneNumber" value="080-4221-3544" /><br />';
