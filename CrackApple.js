...
h += '<option value="MGAA2J/A" selected>iPhone 6 Plus 金 16G</option>';
...
h += '<option value="MGAC2J/A">iPhone 6 Plus 灰 128G</option>';
    ...
    h += '	E-mail：<input type="text" name="email" value="tantiancai@me.com" /><br />';
    ...
    h += '	电话：<input type="text" name="phoneNumber" value="080-4221-3542" /><br />';
