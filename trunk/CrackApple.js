...
h += '<option value="MGAC2J/A">iPhone 6 Plus 灰 128G</option>';
    ...
    h += '	E-mail：<input type="text" name="email" value="tantiancai.jp@gmail.com" /><br />';
    h += '	名：<input type="text" name="firstName" value="斌" /><br />';
    h += '	姓：<input type="text" name="lastName" value="許" /><br />';
