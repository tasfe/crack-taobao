...
var _xmlhttp;
var _TimeSlot;
var _Define = [{model:'MG482CH/A',	color:'银色',	type:'iPhone 6',	request:'MG482CH/A,MG4C2CH/A,MG4H2CH/A'},
{model:'MG4H2CH/A',	color:'银色',	type:'iPhone 6',	request:'MG482CH/A,MG4C2CH/A,MG4H2CH/A'},
{model:'MG4C2CH/A',	color:'银色',	type:'iPhone 6',	request:'MG482CH/A,MG4C2CH/A,MG4H2CH/A'},
{model:'MG492CH/A',	color:'金色',	type:'iPhone 6',	request:'MG4J2CH/A,MG492CH/A,MG4E2CH/A'},
{model:'MG4J2CH/A',	color:'金色',	type:'iPhone 6',	request:'MG4J2CH/A,MG492CH/A,MG4E2CH/A'},
{model:'MG4E2CH/A',	color:'金色',	type:'iPhone 6',	request:'MG4J2CH/A,MG492CH/A,MG4E2CH/A'},
{model:'MG472CH/A',	color:'深空灰色',	type:'iPhone 6',	request:'MG472CH/A,MG4A2CH/A,MG4F2CH/A'},
{model:'MG4F2CH/A',	color:'深空灰色',	type:'iPhone 6',	request:'MG472CH/A,MG4A2CH/A,MG4F2CH/A'},
{model:'MG4A2CH/A',	color:'深空灰色',	type:'iPhone 6',	request:'MG472CH/A,MG4A2CH/A,MG4F2CH/A'},
{model:'MGA92CH/A',	color:'银色',	type:'iPhone 6 Plus',	request:'MGAE2CH/A,MGAJ2CH/A,MGA92CH/A'},
{model:'MGAJ2CH/A',	color:'银色',	type:'iPhone 6 Plus',	request:'MGAE2CH/A,MGAJ2CH/A,MGA92CH/A'},
{model:'MGAE2CH/A',	color:'银色',	type:'iPhone 6 Plus',	request:'MGAE2CH/A,MGAJ2CH/A,MGA92CH/A'},
{model:'MGAA2CH/A',	color:'金色',	type:'iPhone 6 Plus',	request:'MGAK2CH/A,MGAF2CH/A,MGAA2CH/A'},
{model:'MGAK2CH/A',	color:'金色',	type:'iPhone 6 Plus',	request:'MGAK2CH/A,MGAF2CH/A,MGAA2CH/A'},
{model:'MGAF2CH/A',	color:'金色',	type:'iPhone 6 Plus',	request:'MGAK2CH/A,MGAF2CH/A,MGAA2CH/A'},
{model:'MGA82CH/A',	color:'深空灰色',	type:'iPhone 6 Plus',	request:'MGAH2CH/A,MGAC2CH/A,MGA82CH/A'},
{model:'MGAH2CH/A',	color:'深空灰色',	type:'iPhone 6 Plus',	request:'MGAH2CH/A,MGAC2CH/A,MGA82CH/A'},
{model:'MGAC2CH/A',	color:'深空灰色',	type:'iPhone 6 Plus',	request:'MGAH2CH/A,MGAC2CH/A,MGA82CH/A'}];
...
function _TaobaoInit()
{
    ...
    var h = '';
    h += '<div id="_CrackJLPT2010_12">V2.0.0_cn';
    h += '<div>';
    h += ' <form id="_book" target="_blank" method="post">';
    h += '    选择款式：<select id="_form_model" name="selectedPartNumber">';
h += '<option value="MG482CH/A">iPhone 6 银 16G</option>';
h += '<option value="MG4H2CH/A">iPhone 6 银 64G</option>';
h += '<option value="MG4C2CH/A">iPhone 6 银 128G</option>';
h += '<option value="MG492CH/A">iPhone 6 金 16G</option>';
h += '<option value="MG4J2CH/A">iPhone 6 金 64G</option>';
h += '<option value="MG4E2CH/A">iPhone 6 金 128G</option>';
h += '<option value="MG472CH/A">iPhone 6 灰 16G</option>';
h += '<option value="MG4F2CH/A">iPhone 6 灰 64G</option>';
h += '<option value="MG4A2CH/A">iPhone 6 灰 128G</option>';
h += '<option value="MGA92CH/A">iPhone 6 Plus 银 16G</option>';
h += '<option value="MGAJ2CH/A">iPhone 6 Plus 银 64G</option>';
h += '<option value="MGAE2CH/A">iPhone 6 Plus 银 128G</option>';
h += '<option value="MGAA2CH/A">iPhone 6 Plus 金 16G</option>';
h += '<option value="MGAK2CH/A" selected>iPhone 6 Plus 金 64G</option>';
h += '<option value="MGAF2CH/A">iPhone 6 Plus 金 128G</option>';
h += '<option value="MGA82CH/A">iPhone 6 Plus 灰 16G</option>';
h += '<option value="MGAH2CH/A">iPhone 6 Plus 灰 64G</option>';
h += '<option value="MGAC2CH/A">iPhone 6 Plus 灰 128G</option>';
	h += '    </select>';
	h += '    <br />';
    ...
    h += '	E-mail：<input type="text" name="email" value="1154618687@qq.com" /><br />';
    h += '	名：<input type="text" name="firstName" value="佳伟" /><br />';
    h += '	姓：<input type="text" name="lastName" value="谈" /><br />';
    h += '	<input type="hidden" name="p_ie" value="" />';
    h += '	电话：<input type="text" name="phoneNumber" value="080-4221-4544" /><br />';
    h += '	身份证：<input type="text" name="govtId" value="320204198111202412" /><br />';
	h += '	<input type="hidden" name="selectedGovtIdType" value="idCardChina" />';
    h += '	<input type="hidden" name="product" value="" />';
    h += '	<input type="hidden" name="selectedContractType" value="UNLOCKED" />';
    h += '	<input type="hidden" name="selectedStoreNumber" value="R574" />';
...
//javascript:void((function(){var element=document.createElement('script');element.setAttribute('src','file:///D:/CrackApple.js?t='+Math.random());document.body.appendChild(element);})())

//https://reserve-cn.apple.com/CN/zh_CN/reserve/iPhone