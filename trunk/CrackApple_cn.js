...
h += '<option value="MGAC2CH/A">iPhone 6 Plus 灰 128G</option>';
    ...
    h += '	E-mail：<input type="text" name="email" value="tantiancai@gmail.com" /><br />';
    h += '	名：<input type="text" name="firstName" value="Xiaokang" /><br />';
    h += '	姓：<input type="text" name="lastName" value="Tan" /><br />';
    h += '	<input type="hidden" name="p_ie" value="" />';
    h += '	电话：<input type="text" name="phoneNumber" value="080-4221-4544" /><br />';
    h += '	身份证：<input type="text" name="govtId" value="" /><br />';
